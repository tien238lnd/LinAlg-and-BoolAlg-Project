...
void help()
{
	...
	cout << "Arithmetic with matrix is not allowed inside these function (sorry :3).\n";
	cout << "Ex: rank(2*A) is not allow, but rank(A) is ok, or rank([2,3][5,6][0, -1]) is ok too.\n";
	cout << "Specifically, if you want to solve system equations with solve(A, b), you must firstly assign them to 2 variables. Directly type [] inside solve() is not allowed.\n";
	cout << "=======\n";
